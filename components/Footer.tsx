      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-purple-600 rounded flex items-center justify-center font-bold text-lg">F</div>
            <span className="text-xl font-black tracking-tighter text-white font-poppins">FRANCOBEATZ</span>
          </div>
          
          <div className="text-gray-500 text-sm font-medium">
            &copy; {new Date().getFullYear()} FrancoBeatz. All Rights Reserved. 
          </div>
          ...
          <div className="flex space-x-6">
            ...
            <a href="https://www.youtube.com/@FrancoBeatz325" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="mt-8 text-center text-[10px] text-gray-700 uppercase tracking-widest font-black">
          Built for Winners. Powered by FrancoBeatz.
        </div>
      </div>
    </footer>
  );
